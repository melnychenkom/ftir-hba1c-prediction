...
def build_candidates(
    ...
    Args:
        ...
        cv_folds: Folds used for PLSR, Ridge and SVR
        heavy_cv_folds: Folds used for the tree models, 10 as reported.
            Lower it only for an exploratory run
    ...
    return {
        ...
        "Ridge": (
            ...
            {"model__alpha": np.logspace(-1, 5, 13).tolist()},
            cv_folds,
        ),
        "SVR (RBF)": (
